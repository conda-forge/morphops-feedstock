...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/morphops-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14147&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/morphops-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `morphops` can be installed with:

```
conda install morphops
```

It is possible to list all of the versions of `morphops` available on your platform with:
